...
const trustStats = [
  { end: 50, suffix: "+", label: "Components" },
  { end: 10, suffix: "+", label: "Blocks" },
  { end: 7, suffix: "", label: "Themes" },
  { end: 8, suffix: "", label: "Frameworks" },
  { end: 1, suffix: "", label: "MIT Licensed", prefix: "" },
  { end: 1, suffix: "", label: "Open Source", prefix: "" },
];
  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-primary/30 selection:text-primary overflow-x-hidden">
      ...
      <section className="relative pt-16 pb-12 lg:pt-20 lg:pb-20 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-5xl px-6 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-medium tracking-tight text-foreground leading-[0.7]">
            Build <span className="text-primary italic">modern</span>{" "}
            applications <br /> <span className="text-3xl mb-2">with</span>{" "}
            <br />
          ...
          <p className="mx-auto mt-5 max-w-2xl text-base sm:text-lg text-muted-foreground leading-relaxed">
            Open-source components, AI-ready blocks, themes, templates, and
            multi-framework support for modern developers.
          </p>
        ...
        <div className="relative mx-auto max-w-6xl px-6">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <p className="mt-4 text-base text-muted-foreground leading-relaxed">
              Production-ready components that you can copy, paste, and fully
              own. No dependencies. No black boxes.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
            <Card className="bento-card md:col-span-2 md:row-span-2 p-6 bg-gradient-to-br from-primary/5 to-transparent">
            ...
            <Card className="bento-card p-6 bg-gradient-to-br from-blue-500/5 to-transparent">
            ...
            <Card className="bento-card p-6 bg-gradient-to-br from-purple-500/5 to-transparent">
              <div className="flex items-center gap-2 mb-3">
            ...
            <Card className="bento-card p-6 bg-gradient-to-br from-amber-500/5 to-transparent">
              <div className="flex items-center gap-2 mb-3">
            ...
            <Card className="bento-card p-6 bg-gradient-to-br from-rose-500/5 to-transparent">
              <div className="flex items-center gap-2 mb-3">
            ...
            <Card className="bento-card p-6 bg-gradient-to-br from-emerald-500/5 to-transparent">
              <div className="flex items-center gap-2 mb-3">
      ...
      <section className="relative py-20 lg:py-28">
        ...
        <div className="relative mx-auto max-w-6xl px-6">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <p className="mt-4 text-base text-muted-foreground leading-relaxed">
              Launch AI applications faster with production-ready AI components.
              Chat, prompts, streams, and more.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {aiComponents.map((ai) => {
              ...
              return (
                <Card
                  key={ai.title}
                  className="bento-card group bg-card/50 backdrop-blur-sm"
                >
                  <CardContent className="p-5 space-y-4">
                    <div className="flex items-start justify-between">
                      <div
                        className={`h-10 w-10 rounded-xl bg-gradient-to-br ${ai.gradient} flex items-center justify-center ring-1 ring-foreground/5`}
                      >
      ...
      <section className="relative py-20 lg:py-28">
        <div className="relative mx-auto max-w-4xl px-6">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-medium tracking-tight text-foreground leading-[1.15]">
              Why choose <span className="bg-linear-to-r from-primary via-emerald-400 to-teal-500 bg-clip-text text-transparent font-semibold">Static UI</span>?
            </h2>
            <p className="mt-4 text-base text-muted-foreground leading-relaxed">
              We believe in complete component ownership. No lock-in, no hidden
              dependencies, just clean code that belongs to you.
            </p>
          </div>
      ...
      <section className="relative py-20 lg:py-28">
        <div className="relative mx-auto max-w-6xl px-6">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <p className="mt-4 text-base text-muted-foreground leading-relaxed">
              Full-page templates built with Static UI components. Copy,
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {templates.map((tmpl) => (
              ...
              >
                <div
                  className={`h-32 bg-gradient-to-br ${tmpl.color} flex items-center justify-center`}
                >
                    ...
                    {tmpl.slug ? (
                      <>
                        <Button
                          ...
                          onClick={() =>
                            router.push(`/docs/templates/${tmpl.slug}`)
                          }
                        >
                          View Template
                        </Button>
                        <Button
                          ...
                          onClick={() =>
                            handleCopy(
                              `npx @static-ui/cli add ${tmpl.slug}`,
                              `tmpl-${tmpl.slug}`,
                            )
                          }
                        >
                          {copiedCommands[`tmpl-${tmpl.slug}`]
                            ? "Copied!"
                            : "Install"}
                        </Button>
                      </>
        ...
        <div className="relative mx-auto max-w-6xl px-6">
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-8">
            {themes.map((theme) => (
              ...
              >
                <span
                  className={`inline-block h-2 w-2 rounded-full bg-gradient-to-br ${theme.gradient} mr-2`}
                />
                {theme.name}
              </button>
            ))}
          ...
          <Card className="overflow-hidden">
            <div
              className={`h-48 sm:h-64 bg-gradient-to-br ${themes.find((t) => t.slug === activeTheme)?.gradient} flex items-center justify-center`}
            >
      ...
      <section className="relative py-20 lg:py-28">
        ...
        <div className="relative mx-auto max-w-4xl px-6">
          <Card className="bg-gradient-to-br from-primary/5 via-transparent to-transparent border-primary/10 p-8 md:p-12 text-center">
            <div className="max-w-xl mx-auto space-y-6">
              ...
              <p className="text-base text-muted-foreground leading-relaxed">
                MIT licensed. Community driven. Built in the open. We believe
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
                <Button
                  onClick={() =>
                    router.push("https://github.com/Anshul563/static-ui")
                  }
                  size="lg"
                  className="group text-base h-11 px-6"
                >
          ...
          <Card className="bg-muted/30 border-dashed border-border/50 p-8">
            <div className="max-w-sm mx-auto space-y-3">
              ...
              <p className="text-xs text-muted-foreground/60">
                Your testimonial could be here. Join our community and share
                your experience.
              </p>
            </div>
          </Card>
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <div className="space-y-2.5">
                <p className="leading-relaxed">
                  Open-source component library for modern web applications.
                  Copy, paste, own.
                </p>
