...
const INSTALLED_SLUGS = new Set([
  ...
  "scroll-area", "select", "separator", "sidebar", "skeleton", "slider",
  "sonner", "spinner", "switch", "table", "tabs", "textarea", "toast",
    ...
    return (
      <Table>
        ...
        <TableBody>
          ...
          <TableRow><TableCell>Charlie</TableCell><TableCell>Manager</TableCell><TableCell>Inactive</TableCell></TableRow>
        </TableBody>
      </Table>
    );
  },
...
const registry: Record<string, ComponentMeta> = {
  ...
  alert: {
    name: "Alert",
    description: "Displays a brief, important message that requires the user's attention without interrupting their workflow.",
  ...
  "alert-dialog": {
    name: "Alert Dialog",
    description: "A modal dialog that interrupts the user with urgent information or requires a critical confirmation decision.",
  ...
  "aspect-ratio": {
    name: "Aspect Ratio",
    description: "Displays content within a desired ratio while preserving the element's intrinsic dimensions.",
  ...
  badge: {
    name: "Badge",
    description: "A small visual label that highlights status, categorises content, or displays counts at a glance.",
    code: `import { Badge } from "@static-ui/ui"\n\nexport function BadgeDemo() {\n  return (\n    <div className="flex gap-2">\n      <Badge variant="default">Default</Badge>\n      <Badge variant="secondary">Secondary</Badge>\n      <Badge variant="destructive">Destructive</Badge>\n      <Badge variant="outline">Outline</Badge>\n    </div>\n  )\n}`,
  },
  breadcrumb: {
    name: "Breadcrumb",
    description: "Displays the current page location within a navigational hierarchy as a chain of clickable segments.",
  ...
  button: {
    name: "Button",
    description: "An interactive element used to trigger actions, submit forms, or navigate across application views.",
    code: `import { Button } from "@static-ui/ui"\n\nexport function ButtonDemo() {\n  return (\n    <div className="flex gap-4">\n      <Button variant="default">Default</Button>\n      <Button variant="outline">Outline</Button>\n      <Button variant="destructive">Destructive</Button>\n    </div>\n  )\n}`,
  },
  calendar: {
    name: "Calendar",
    description: "A date picker component that lets users select single dates or ranges through an interactive month grid.",
    code: `import { Calendar } from "@static-ui/ui"\n\nexport function CalendarDemo() {\n  const [date, setDate] = useState<Date | undefined>(new Date())\n  return (\n    <Calendar mode="single" selected={date} onSelect={setDate} className="rounded-md border" />\n  )\n}`,
  },
  card: {
    name: "Card",
    description: "A flexible container that groups related content and actions into a single visually bounded surface.",
  ...
  carousel: {
    name: "Carousel",
    description: "A horizontally scrolling container that cycles through a set of items, one at a time.",
  ...
  checkbox: {
    name: "Checkbox",
    description: "A binary control that allows users to toggle between checked and unchecked states for selections.",
  ...
  collapsible: {
    name: "Collapsible",
    description: "An expandable section that reveals and hides content with a smooth animated toggle transition.",
  ...
  "context-menu": {
    name: "Context Menu",
    description: "A right-click contextual menu that surfaces relevant actions based on the target element.",
  ...
  dialog: {
    name: "Dialog",
    description: "A modal overlay that focuses the user on a specific task or piece of content by dimming the background.",
  ...
  drawer: {
    name: "Drawer",
    description: "A mobile-first panel that slides in from the bottom or edge of the viewport to reveal related actions.",
  ...
  "dropdown-menu": {
    name: "Dropdown Menu",
    description: "A floating menu of actions or links triggered by clicking a toggle element like a button or avatar.",
  ...
  "hover-card": {
    name: "Hover Card",
    description: "A floating card that reveals rich preview content when the user hovers over a trigger element.",
  ...
  input: {
    name: "Input",
    description: "A styled text field that accepts user input for forms, search, or data entry workflows.",
    code: `import { Input } from "@static-ui/ui"\n\nexport function InputDemo() {\n  return (\n    <div className="flex flex-col gap-2">\n      <Input placeholder="Enter your email..." />\n      <Input placeholder="Disabled" disabled />\n    </div>\n  )\n}`,
  },
  label: {
    name: "Label",
    description: "A text label paired with a form control, providing accessible naming and click-to-focus behaviour.",
    code: `import { Label } from "@static-ui/ui"\n\nexport function LabelDemo() {\n  return (\n    <div className="flex flex-col gap-2">\n      <Label htmlFor="name">Name</Label>\n      <Input id="name" placeholder="Enter your name" />\n    </div>\n  )\n}`,
  },
  pagination: {
    name: "Pagination",
    description: "Controls for navigating through multi-page datasets with page numbers and next/previous buttons.",
  ...
  popover: {
    name: "Popover",
    description: "A floating overlay that appears near a trigger to present additional options or inline information.",
  ...
  progress: {
    name: "Progress",
    description: "A visual indicator that displays the completion status of a task or process as a filled bar.",
  ...
  "radio-group": {
    name: "Radio Group",
    description: "A set of mutually exclusive options where only one choice can be selected at any given time.",
  ...
  "scroll-area": {
    name: "Scroll Area",
    description: "A custom-styled scroll container that replaces the native browser scrollbar for consistent cross-browser design.",
  ...
  select: {
    name: "Select",
    description: "A dropdown picker that lets users choose a single value from a collapsible list of predefined options.",
  ...
  separator: {
    name: "Separator",
    description: "A thin visual divider that separates content sections or groups into distinct horizontal or vertical zones.",
    code: `import { Separator } from "@static-ui/ui"\n\nexport function SeparatorDemo() {\n  return (\n    <div className="flex flex-col gap-2">\n      <p className="text-sm">Content above</p>\n      <Separator />\n      <p className="text-sm">Content below</p>\n    </div>\n  )\n}`,
  },
  skeleton: {
    name: "Skeleton",
    description: "A placeholder that mimics the shape of content while it loads, reducing perceived wait time.",
    code: `import { Skeleton } from "@static-ui/ui"\n\nexport function SkeletonDemo() {\n  return (\n    <div className="flex items-center gap-4">\n      <Skeleton className="h-12 w-12 rounded-full" />\n      <div className="space-y-2">\n        <Skeleton className="h-4 w-48" />\n        <Skeleton className="h-4 w-32" />\n      </div>\n    </div>\n  )\n}`,
  },
  slider: {
    name: "Slider",
    description: "A range input that lets users select a numeric value by dragging a handle along a horizontal track.",
    code: `import { Slider } from "@static-ui/ui"\n\nexport function SliderDemo() {\n  const [value, setValue] = useState([50])\n  return (\n    <div className="w-60 space-y-2">\n      <Slider value={value} onValueChange={setValue} max={100} step={1} />\n      <p className="text-xs text-neutral-400">Value: {value[0]}</p>\n    </div>\n  )\n}`,
  },
  sonner: {
    name: "Sonner",
    description: "An opinionated toast notification system that stacks brief, dismissible messages in the corner of the viewport.",
  ...
  switch: {
    name: "Switch",
    description: "A toggle control that instantly enables or disables a setting with a single click.",
  ...
  table: {
    name: "Table",
    description: "A clean data table layout with styled rows, header columns, and responsive overflow handling.",
  ...
  tabs: {
    name: "Tabs",
    description: "A tabbed interface that switches between multiple content panels while keeping only one active at a time.",
  ...
  textarea: {
    name: "Textarea",
    description: "A multi-line text input that accommodates longer form responses such as comments or descriptions.",
    code: `import { Textarea } from "@static-ui/ui"\n\nexport function TextareaDemo() {\n  return <Textarea placeholder="Write your message here..." className="w-80" />\n}`,
  },
  toast: {
    name: "Toast",
    description: "A lightweight notification that temporarily appears to confirm an action or alert the user.",
  ...
  toggle: {
    name: "Toggle",
    description: "A button that switches between an on and off visual state, often used for formatting toolbars.",
    code: `import { Toggle } from "@static-ui/ui"\n\nexport function ToggleDemo() {\n  return (\n    <Toggle aria-label="Toggle bold">\n      <Bold className="h-4 w-4" />\n    </Toggle>\n  )\n}`,
  },
  tooltip: {
    name: "Tooltip",
    description: "A small contextual label that appears on hover or focus to explain an element's purpose.",
...
const accessibilityNotes: Record<string, string> = {
  accordion: "Uses WAI-ARIA Accordion pattern. Each panel is controlled by its triggering button via `aria-expanded` and `aria-controls` attributes.",
  alert: "Uses `role=\"alert\"` to announce dynamic content to screen readers. Optionally supports `role=\"alertdialog\"` for interactive alerts.",
  "alert-dialog": "Implements the WAI-ARIA Alert Dialog pattern. Focus is trapped within the dialog. Uses `role=\"alertdialog\"` and `aria-modal=\"true\"`.",
  avatar: "Requires `alt` text on `AvatarImage` for screen reader users. The `AvatarFallback` provides accessible text when the image fails to load.",
  breadcrumb: "Uses `nav` element with `aria-label=\"Breadcrumb\"`. Each segment is a link except the current page which uses `aria-current=\"page\"`.",
  button: "Uses native `<button>` element, providing built-in keyboard interaction and focus management. Supports `aria-pressed` for toggle states.",
  card: "Uses semantic HTML sections. Cards are focusable when interactive. Use `article` or `section` elements as appropriate.",
  carousel: "Requires `aria-roledescription=\"carousel\"` and `aria-label` on the container. Each slide uses `role=\"group\"` with `aria-roledescription=\"slide\"`.",
  checkbox: "Supports indeterminate state via `aria-checked=\"mixed\"`. Uses native `<input type=\"checkbox\">` for built-in accessibility.",
  dialog: "Implements the WAI-ARIA Dialog pattern. Focus is trapped. Uses `role=\"dialog\"` and `aria-modal=\"true\"`. Closes on `Escape` key.",
  "dropdown-menu": "Follows WAI-ARIA Menu pattern. Uses `role=\"menu\"`, `role=\"menuitem\"`. Arrow key navigation between items.",
  "hover-card": "Uses `aria-describedby` to link the trigger to the card content. Appears on hover or focus. Dismissible with `Escape`.",
  input: "Uses native `<input>` elements for built-in form accessibility. Supports `aria-invalid`, `aria-describedby`, and `aria-required`.",
  "radio-group": "Implements the WAI-ARIA Radio Group pattern. Uses `role=\"radiogroup\"` and `role=\"radio\"`. Arrow key navigation between options.",
  select: "Implements the WAI-ARIA Listbox pattern. Uses `role=\"combobox\"` and `role=\"listbox\"` with `aria-selected` for options.",
  skeleton: "Uses `aria-hidden=\"true\"` since skeleton placeholders are decorative. Content should be announced when loaded.",
  slider: "Uses `role=\"slider\"` with `aria-valuemin`, `aria-valuemax`, `aria-valuenow` attributes. Supports keyboard arrow navigation.",
  switch: "Uses `role=\"switch\"` with `aria-checked` to indicate the toggle state. Supports keyboard activation via `Space` or `Enter`.",
  tabs: "Implements the WAI-ARIA Tabs pattern. Uses `role=\"tablist\"`, `role=\"tab\"`, `role=\"tabpanel\"` with `aria-selected` and `aria-controls`.",
  textarea: "Uses native `<textarea>` element for built-in form accessibility. Supports `aria-invalid` and `aria-describedby`.",
  toast: "Uses `role=\"status\"` or `role=\"alert\"` for live region announcements. Automatically announced by screen readers.",
  toggle: "Uses `aria-pressed` to indicate the pressed state. Keyboard accessible via `Space` or `Enter`.",
  tooltip: "Uses `aria-describedby` to link the trigger to the tooltip content. Appears on hover and focus. Not focusable itself.",
};
